...
{
    var isCid = template.Namespace.Contains("CustomerIdentityItems");
    var shortNamespace = template.Namespace
        .Replace("Items.Sitecore.templates.Feature.azblue.", "")
        .Replace("Items.Sitecore.templates.Foundation.azblue.", "")
        .Replace("Items.Sitecore.templates.Project.azblue.", "")
        .Replace("CustomerIdentityItems.Sitecore.templates.Feature.CustomerIdentity.", "")
        .Replace("CustomerIdentityItems.Sitecore.templates.Foundation.CustomerIdentity.", "")
        .Replace("CustomerIdentityItems.Sitecore.templates.Project.CustomerIdentity.", "");
    return $"{(isCid ? "Cid" : "")}{shortNamespace}";
}
...
public string GetFieldType(TemplateFieldCodeGenerationMetadata field)
{
    switch (field.Type.ToLower())
    {
        ...
        case "valuelookup":
            return "Field<string>";
        default:
            return $"unknown // {field.Type.ToLower()}";
    }
}
