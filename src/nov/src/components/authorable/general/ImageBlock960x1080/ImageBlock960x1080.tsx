...
export interface ImageBlock960x1080Props {
  uid?: string;
...
const ImageBlock960x1080 = ({ fields }: ImageBlock960x1080Props): JSX.Element => {
  return (
    <div className="w-full h-auto relative bg-black ">
