    ...
    <>
      <div className="container article-text">
        <div className="max-w-[736px] m-auto">
          <RichTextA11yWrapper
            field={fields?.body}
            className="text-black [&_p]:text-gray-dark [&_p]:mb-5 [&_a]:text-base [&_a]:lg:leading-32 [&_a]:leading-28 [&_p]:text-base [&_p]:leading-28 [&_p]:lg:leading-32 [&_h4]:text-5xl [&_h4]:leading-42 [&_h4]:mb-3.5 [&_h4]:mt-[22.5px] [&_h4]:text-black [&_h4_strong]:font-bold"
          />
