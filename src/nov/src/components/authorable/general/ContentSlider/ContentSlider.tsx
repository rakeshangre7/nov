          ...
          <div className="w-full h-[620px] smd:h-[570px] relative" key={index}>
            ...
            {content?.fields?.cta?.value?.href && content?.fields?.cta?.value?.text && (
              <Button
                ...
                className="active:!no-underline absolute bottom-0 w-[calc(100%-116px)] smd:w-4/12 h-[54px] smd:h-20 !font-normal !text-base !leading-24 smd:!text-2xl smd:!leading-32 font-primary smd:!font-bold py-6 px-8 !justify-start"
                variant="button"
              />
            )}
          </div>
